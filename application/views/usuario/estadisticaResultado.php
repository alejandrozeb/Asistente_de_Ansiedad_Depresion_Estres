    ...
    <div class="container">
        <div class="row">
            <div class="col s12">
                ...
                <p class="flow-text">Evolución de tus niveles de ansiedad, estrés y depresión.  </p>
                <p class="flow-text">Solo se toma en cuenta el ultimo cuestionario llenado en el día. </p>
            </div>
            <div class="col l12">
